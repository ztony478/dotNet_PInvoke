...
namespace MarshalStruct_Argument
{
    class Program
    {
        ...
        {
            Console.WriteLine("托管代码定义的结构体在非托管代码中的大小为：{0}字节", Marshal.SizeOf(typeof(ManagedSimpleStruct)));
        ...
        private static void TestWrongPack()
        {
            ...
            Console.WriteLine("\n========================\n错误的内存对齐方式:");
            Console.ResetColor();
            Console.WriteLine("托管代码定义的结构体在非托管代码中的大小为：{0}字节", Marshal.SizeOf(typeof(ManagedSimpleStruct_WrongPack)));
