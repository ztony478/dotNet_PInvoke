...
namespace MarshalStruct_ExactLayout
{
    class Program
    {
        ...
        private static void TestStructExactLayout()
        {
            ...
            Console.WriteLine("职级: {0}", employee.CurrentLevel);
            Console.WriteLine("区域代码: {0}", employee.RegionId);
            Console.WriteLine("邮政编码: {0}", employee.ZipCode);
            Console.WriteLine("工资: {0}", employee.CurrentSalary);
        }
